...
%% Problem1 - Quad_10_10, GradientDescentW, Wolfe
...
disp(f);
toc
%%  Problem1 - Quad_10_10, Modified Newton, Backtracking
...
%%  Problem1 - Quad_10_10, Modified Newton, Wolfe
%set problem (minimal requirement: name of problem)
...
%% Problem1 - Quad_10_10, BFGS, Backtracking
%set problem (minimal requirement: name of problem)
...
%% Problem 1 - Quad_10_10, BFGS, Wolfe
%set problem (minimal requirement: name of problem)
...
%%  Problem 1 - Quad_10_10, TRNewtonCG
%set problem (minimal requirement: name of problem)
...
%%  Problem 1 - Quad_10_10, DFP, Backtracking
...
%%  Problem 1 - Quad_10_10, DFPW, Wolfe
problem.name = 'P1_quad_10_10';
problem.x0 = 20*rand(10, 1)-10;
problem.n = length(problem.x0);
problem.opt_val = -67.9575;
